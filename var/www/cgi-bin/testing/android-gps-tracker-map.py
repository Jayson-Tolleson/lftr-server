...
#put center of map polygon tile as printed lat/long realtime
...
ee.Initialize()
ee.mapclient.centerMap("lat", "long" , 12)

# Filter to a boundaries.a square around that location center
polygon = ee.Geometry.Polygon([[
    ["lat"-2, "long"+2], ["lat"+2, "long"+2], ["lat"-2, "long"-2], ["lat"-2, "long"+2]]])
