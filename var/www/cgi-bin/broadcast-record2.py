...
iframe#embed
{
    width:2600px;       /* set this to approximate width of entire page you're $
    height:3800px;      /* determines where the bottom of the page cuts off */
    margin-left:-0px; /* clipping left side of page */
    margin-top:-2350px;  /* clipping top of page */
    overflow:hidden;
...
{ 
  width: 1420px;
  height: 420px;
  background: #ff7f01 url(menu.png) repeat-x;} 
...
{ letter-spacing: 0.2em;
  font: normal 150% 'lucida sans unicode', arial, sans-serif;
  display: block; 
  float: left; 
  height: 50px;
...
<body>
  <div id="main">
    <div id="site_content">            
      <div id="content">
<h1>---
---HTTPS://LFTR.BIZ/CGI-BIN/BROADCAST-RECORD.PY</h1>
<div class="row">
  <div class="column">
...
<body>
            <div class="make-center">
                <input type="text" id="room-id" value="hello">
                <button id="join-room">JOIN AND VIEW MY BROADCAST (hello) ROOM</button>
                <button id="open-or-join-room"></button>
                <button id="open-room">START A BROADCAST</button>

                <div id="room-urls" style="text-align: center;display: none;background: #F1EDED;margin: 15px -10px;border: 1px solid rgb(189, 189, 189);border-left: 0;border-right: 0;"></div>
            </div>

            <div id="videos-container" style="width: 1480px" autoplay controls></div>
        </section>
...
<canvas id="canvas" width="1100" height="1100"
